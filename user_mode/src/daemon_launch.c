...
int main() {
    ...
    if (!pid_kill) {
        /* kill_daemon */
        char *argv[] = {KILL_SUBDAEMON_PATH, (char*)0};
        execv(KILL_SUBDAEMON_PATH, argv);
        ...
        if (!pid_write) {
            /* write_daemon */
            char *argv[] = {WRITE_SUBDAEMON_PATH, (char*)0};
            execv(WRITE_SUBDAEMON_PATH, argv);
            ...
            if (!pid_unlink) {
                /* unlink_daemon */
                char *argv[] = {UNLINK_SUBDAEMON_PATH, (char*)0};
                execv(UNLINK_SUBDAEMON_PATH, argv);
